...
class TextStyles {
  ...
  static TextStyle font20MainGreenSemiBold = TextStyle(
      fontSize: 20.sp,
  ...
  static TextStyle font18lackSemiBold = TextStyle(
      ...
      fontWeight: FontWeightHelper.semiBold,
      fontFamily: AppConstants.appFontFamily);
  static TextStyle font18lackBold = TextStyle(
      fontSize: 18.sp,
      color: Colors.black,
      fontWeight: FontWeightHelper.bold,
      fontFamily: AppConstants.appFontFamily);
  static TextStyle font12MainGreenSemiBold = TextStyle(
      fontSize: 12.sp,
      color: ColorsManager.mainGreen,
  ...
  static TextStyle font14BlackRegular = TextStyle(
      ...
      fontWeight: FontWeightHelper.regular,
      fontFamily: AppConstants.appFontFamily);
  static TextStyle font14MainGreenSemiBold = TextStyle(
      fontSize: 14.sp,
      color: ColorsManager.mainGreen,
      fontWeight: FontWeightHelper.semiBold,
      fontFamily: AppConstants.appFontFamily);
  ...
  static TextStyle font11BlackRegular = TextStyle(
      ...
      fontWeight: FontWeightHelper.regular,
      fontFamily: AppConstants.appFontFamily);
  static TextStyle font11MainGreenRegular = TextStyle(
      fontSize: 11.sp,
      color: ColorsManager.mainGreen,
      decoration: TextDecoration.underline,
      decorationColor: ColorsManager.mainGreen,
